...
GO
/*
The column Name on table [dbo].[Roles] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
ALTER TABLE [dbo].[Roles] DROP CONSTRAINT [UQ__Roles__737584F6CFEF7B5A];
...
GO
ALTER TABLE [dbo].[Profiles] ALTER COLUMN [UserId] BIGINT NULL;
...
GO
ALTER TABLE [dbo].[Roles] ALTER COLUMN [Name] NVARCHAR (30) NOT NULL;
